        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($popularCourses as $course)
                    <a href="{{ route('courses.show', $course->id) }}" class="group bg-white rounded-2xl border-2 border-gray-100 overflow-hidden hover:shadow-2xl transition-all card-hover p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-5 line-clamp-3 leading-relaxed">{{ $course->description }}</p>
